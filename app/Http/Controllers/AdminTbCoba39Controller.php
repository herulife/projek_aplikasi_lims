<?php namespace App\Http\Controllers;
	...
	class AdminTbCoba39Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Body','name'=>'body','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'User','name'=>'user','type'=>'select2','width'=>'col-sm-10','datatable'=>'cms_users,name'];
